...
RSpec.describe "video_technical_details/new", type: :view do
  before(:each) do
    assign(:video_technical_detail, VideoTechnicalDetail.new(
      video: nil,
      duration: "9.99",
      bitrate: 1,
      file_size: 1,
  ...
  it "renders new video_technical_detail form" do
    render

    assert_select "form[action=?][method=?]", video_technical_details_path, "post" do
